...
export function Footer() {
  return (
    <footer className="border-t border-border/40 glass mt-auto relative z-10">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0 pt-6 border-t border-border/40">
